...
def ingest(
    ...
    """
    Production-style raw AWS telemetry ingestion.
    ...
    The backend then:
        ...
        1. Retrieves station history from PostgreSQL.
        2. Retrieves multistation spatial context.
        3. Builds the exact 50 model features.
        4. Runs Stage 1 anomaly detection.
        5. Runs Stage 2 weather-vs-sensor classification.
        6. Generates evidence and fault component.
        7. Persists the processed result as LIVE data.
    ...
    try:
        ...
        #
        # 96 observations = 24 hours at 15-minute
        # sampling frequency.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Retrieve latest multistation context.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Add the CURRENT observation to spatial context.
        #
        # It has not been persisted yet, so the feature engine
        # needs it explicitly.
        # ----------------------------------------------------
        ...
        # Explainability evidence.
        #
        # -999 means the feature is unavailable.
        # It must NOT be interpreted as strong evidence.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Persist processed LIVE reading.
        # ----------------------------------------------------
